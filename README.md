...
За основу логики проксирования (Node.js) был взят отличный проект для ПК — tg-ws-proxy.
Огромная благодарность автору @Flowseal за крутой концепт и открытый исходный код!
